...
class _LocationEditPageState extends State<LocationEditPage> {
  ...
  void _initializeControllers() {
    ...
    print('🔧 DEBUG: Initialized edit form with Location: ${widget.LocationData['location']}');
    print('🔧 DEBUG: Location ID: ${widget.LocationData['location_id']}');
    print('🔧 DEBUG: Company ID: ${widget.LocationData['company_id']}');
  }
  ...
  Future<void> _pickImage() async {
    try {
      ...
      if (image != null) {
        ...
        print('📷 DEBUG: New image selected for Location update');
      }
    } catch (e) {
  ...
  'company_id': CompanyConfig.getCompanyId(), // Add this line
      ...
      print('📝 DEBUG: Update data: ${locationData.toString()}');
      ...
      print('❌ DEBUG: Error updating Location: $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Row(
            children: [
  ...
  Future<void> _deleteLocation() async {
    ...
    try {
      ...
      final url = AppConfig.api('/api/iolocation/$locationId');
      print('🗑️ DEBUG: Deleting Location at: $url');
      ...
      print('❌ DEBUG: Error deleting Location: $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Row(
            children: [
