...
class _LocationEditPageState extends State<LocationEditPage> with TickerProviderStateMixin {
  ...
  void _initializeControllers() {
    ...
    print('Initialized edit form with Location: ${widget.LocationData['location']}');
    print('Location ID: ${widget.LocationData['location_id']}');
    print('Company ID: ${widget.LocationData['company_id']}');
  }
  ...
  Future<void> _updateLocation() async {
    ...
    try {
      ...
      print('Update data: ${locationData.toString()}');
  ...
  Future<void> _deleteLocation() async {
    ...
    try {
      ...
      final url = AppConfig.api('/api/iolocation/$locationId');
      print('Deleting Location at: $url');
  ...
  void _showSuccessDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Location "${_locationNameController.text}" has been updated successfully!'),
        actions: [
          TextButton(
            onPressed: () {
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () {
              Navigator.of(context).pop(); // Close dialog
              Navigator.of(context).pop('deleted'); // Return 'deleted' to Location list
            },
            child: Text(
              'OK',
              style: TextStyle(
