...
class _LocationAddPageState extends State<LocationAddPage> with TickerProviderStateMixin {
  ...
  Future<void> _createLocation() async {
    ...
    try {
      ...
      print('📝 DEBUG: Location data: ${locationData.toString()}');
      ...
      print('❌ DEBUG: Error creating Location: $e');
  ...
  void _showSuccessDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Location "${_locationNameController.text}" has been created successfully.'),
        actions: [
          TextButton(
            onPressed: () {
